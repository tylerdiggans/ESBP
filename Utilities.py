...
#############################################################
## Basic Genetic Algorithm to obtain a reasonable energy 
#		starting point to relax via physics based forces
...
#####################################################################
###SOURCE: https://gist.github.com/joe-jordan/6548029#file-cycles-py#
#####################################################################
...
if __name__=='__main__':
	...
	# This function can be run to plot many type of representations
	#    of the graphs and backbones including most plots in the paper
	# In addition GIFs can be created that rotate the graph while 
	#  removing edges in order resulting in the GESB
